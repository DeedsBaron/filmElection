<template>
  <div>
    <div id="confetti-holder" :class="applyBack">
      ...
      <canvas v-show="this.$store.state.Users.finished" id="my-canvas" style="position:absolute; top:0px; left:0px; z-index:1; height: 100%; width: 100%" ></canvas>
      <!--    <p>{{users()[0]}}</p>-->
  <!--    <p>{{users()[1]}}</p>-->
